    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Tabs */}
                <div className="bg-white flex rounded-lg shadow-lg mb-6">
                    <div className='w-[70%]'>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${sort === 'volume'
                                            ...
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${sort === 'value'
                                                    ? 'bg-blue-600 text-white'
                                                    : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-300'
                                                    }`}
                                            >
